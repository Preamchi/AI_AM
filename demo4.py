...
# set Image_Path ----------------------------------------------------------------------------------------------------------
    ...
    config['AI_Check']['NG_Count'] = str(count)
...
if __name__ == "__main__":
    ...
    while True:   
        ...
        if (config["AI_Check"]["start"].value == "1"):
            ...
            shape11 = [(20, 20), (w11 - 10, h11 - 10)] 
            shape22 = [(20, 70), (w22 - 10, h22 - 10)]
            shape33 = [(295, 20),(w33 - 10, h33 - 10)] 
            shape44 = [(295, 70),(w44 - 10, h44 - 10)] 
            ...
            for file in os.listdir(model):
                ...
                if date_fol:
                    ...
                    if files:
                        ...
                        ng_count = config.get("AI_Check", "NG_Count").value
                        ...
                        if (new_sn != old_sn or old_sn == ""):
                            ...
                            if result == "NG":
                                ...
                                draw.rectangle(shape11, fill="#000000")
                                draw.text((110, 22), "RESULT", font=fontmodel, fill=(255, 255, 255))

                                draw.rectangle(shape33, fill="#000000")
                                draw.text((337, 22), "NG COUNT", font=fontmodel, fill=(255, 255, 255))

                                draw.rectangle(shape44, fill=(217, 217, 217))
                                int_num = int(ng_count)

                                if int_num <= 9:  
                                    draw.text((384, 75), ng_count, font=font_result, fill=(74, 74, 74))
                                else:
                                    draw.text((365, 75), ng_count, font=font_result, fill=(74, 74, 74))
                               
                                draw.rectangle(shape22, fill=(0, 0, 255))
