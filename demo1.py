...
def run(
        config_file="C:/Users/5022820537/yolov5/sol_config.ini",
    ...
    with open('C:/Users/5022820537/yolov5/sol_config.ini', 'w') as cf:   
       config.write(cf)
...
# set Image_Path ----------------------------------------------------------------------------------------------------------
    ...
    with open('C:/Users/5022820537/yolov5/sol_config.ini', 'w') as f:   
        config.write(f)
                ...
                if date_fol:
                    ...
                    if files:
                        ...
                        if (new_sn != old_sn or old_sn == ""):
                            img = "C:/Users/5022820537/yolov5/data/images/frameimage.png"  
